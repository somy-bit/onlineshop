...
const ProductDetails = ({ product, otherProducts }) => {
    ...
    const { product_name, product_image, price, description,  persian_name } = product;
    ...
    return (
        <div>
            <div className='product-detail-container'>
                ...
                <div className='product-detail-desc'>
                    ...
                    <div className='buttons'>
                        ...
                        <button type='button' onClick={addProduct} className='add-to-cart'>{lang == 'en' ? 'Add to basket' : 'اضافه کن'}</button>
                        <button type='button' onClick={() => onBuyNow(product, qty)} className='buy-now'>{lang == 'en' ? 'Buy Now' :  'الان بخر'}</button>
            ...
            <div className='maylike-products-wrapper'>
                <h2>{lang == 'en' ? 'Other Products' : 'محصولات مشابه'}</h2>
