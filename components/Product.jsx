...
const Product = ({ product}) => {
  ...
  const { product_name, slug, product_image, price,_id,arabic_name,persian_name,in_sale} = product;
      ...
      <Link href={`/product/${slug.current}`}>
        <div className='product-card'>
          ...
          <>
           ...
           />
           {/* {in_sale&&
           <div className='absolute top-3 right-3 flex items-center justify-center p-3 text-xs text-white h-8 w-8 rounded-full bg-red-400'>20%</div>
          } */}
           </>}
