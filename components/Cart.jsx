    ...
    return (
        <div className='cart-wrapper' ref={cartRef}>
            <div className='cart-container'>
                ...
                >
                    <FaAngleLeft />
                    <span className='heading'>{lang=='en'?'Your Basket':'سبد خرید شما'}</span>
                    <span className='cart-num-items'>({totalQuantity} {lang=='en'?'item':'مورد'})</span>
                </button>

                {cartItems.length < 1 && (
                    <div className='empty-cart flex flex-col items-center'>
                        <FaShoppingBasket size={150} />
                        <h3 >{lang=='en'?'Your basket is empty':'سبد شما خالی است'}</h3>
                        <Link href='/'>
                            <button
                                className='btn'
                                type='button'
                                onClick={() => setShowCart(false)}
                            >{lang=='en'?'Continue Shopping':'ادامه خرید'}</button>
                        </Link>
                    </div>
                )}
                            ...
                            <div className='item-desc'>
                                ...
                                <div className='flex flex-1 justify-center p-4 items-center text-red-400'>
                                    ...
                                    <button
                                        ...
                                        <TiDeleteOutline />
                                        <p>{lang=='en'?'Delete Item':'مورد را حذف کنید'}</p>
                                    </button>
                                    </>
                                </div>
                ...
                {cartItems.length >=1 && (
                    <div className='cart-bottom'>
                        ...
                        <div className='btn-container'>
                            ...
                            >
                          {lang=='en'?'Checkout':'خرید خود را ثبت کنید'}</button>
                        </div>
                    </div>
                )}
            </div>
