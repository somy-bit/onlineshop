...
const Register = () => {
    ...
    return (
        <div className='flex flex-col space-y-6 mt-12 mb-32 w-full  justify-center items-center '>
              <Link href='/'>
            ...
            <form className='w-3/4  p-10 space-y-4 rounded-xl  bg-gray-200 max-w-2xl shadow-lg '>
                ...
                <div className='flex flex-col justify-start space-y-2'>
                    ...
                    <input type='password' className='p-3 border-gray-300 rounded-lg' value={password} onChange={(e) => setPassword(e.target.value)} placeholder='password..' />
                </div>
                {userType === 'user' &&
            ...
            <div className='flex flex-row items-center space-x-2'><p className='text-sm text-gray-600'>Heeft u al een account? </p><Link href='/registerNewUser'><p className='text-green-400 font-semibold cursor-pointer'>Inloggen</p></Link></div>
